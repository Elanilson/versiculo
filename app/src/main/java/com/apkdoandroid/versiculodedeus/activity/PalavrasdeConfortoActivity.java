...
public class PalavrasdeConfortoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_palavrasde_conforto);
        recyclerView = findViewById(R.id.recyclerViewPalavra_conforto);
        geradorversiculos();
    ...
    private void geradorversiculos() {
        ...
        for(Versiculo versiculo: dao.listarPalavrasdeConforto()){
