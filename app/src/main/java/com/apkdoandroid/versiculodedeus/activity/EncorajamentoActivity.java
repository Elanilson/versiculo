...
public class EncorajamentoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recyclerViewEncorajamento);
        geradorversiculos();
    ...
    private void geradorversiculos() {
        ...
        for(Versiculo versiculo: dao.listarEncorajamento()){
